  ...
  const BuyNowPaylaterPlanModalContent = () => {
    ...
    return (
      <>
              ...
              <div className="flex justify-between my-3" key={paymentItem?._id}>
                ...
                <div className="flex flex-col gap-3">
                  {paymentItem?.status === "Pending" && (
                    <div className="bg-status-errorBg text-xs font-[400] px-4 py-1 rounded-3xl flex items-center justify-center">
                  ...
                  {paymentItem?.status === "Paid" && (
                    <div className="bg-status-successBgAlt text-xs font-[400] px-4 py-1 rounded-3xl flex items-center justify-center">
        ...
        <div className="flex gap-10 bg-status-successBg px-5 py-2 my-3">
          <h4>Total</h4>
    ...
    if (AvailablePayment) {
      ...
      return (
        <>
          ...
          <div className="flex gap-10 bg-status-successBg px-5 py-2 mt-3 mb-10">
            <h4>Total</h4>
            <h4 className="text-base text-primary-300 font-bold">
              {FormatMoney2(totalAmount)}
            </h4>
      ...
      <table className="table-auto min-w-full">
        <thead className="bg-gray-50">
          <tr className="bg-gray-100">
            ...
            <th
              scope="col"
              className="text-center text-xs font-semibold px-6 py-2 text-gray-700 uppercase tracking-wider"></th>
          </tr>
        </thead>
          ...
          {itemData &&
            ...
            itemData?.orders.map((item, i) => {
              ...
              return (
                <tr
                  key={i}
                  className={i % 2 === 0 ? "bg-neutral-bg" : "bg-white"}>
                  ...
                  <td className="px-5 py-3 leading-6 text-center whitespace-nowrap font-medium text-sm">
                    ...
                    {item?.status === "Pending" && (
                      <div className="bg-status-pendingBg px-4 py-1 rounded-3xl">
                    ...
                    {item?.status === "Accept" && (
                      <div className="bg-status-successBgAlt px-4 py-1 rounded-3xl">
                        <span className="text-status-success">
                          {item?.status}
                        </span>
                      </div>
                    ...
                    {item?.status === "Rejected" && (
                      <div className="bg-status-errorBg px-4 py-1 rounded-3xl">
                        <span className="text-status-error">
                          {item?.status}
                        </span>
                      </div>
                    ...
                    checkPaymentStatus(item) === "Pending" && (
                      <td className="px-5 py-3 leading-6 text-center whitespace-nowrap">
                        <span
                          ...
                          className="text-link hover:underline cursor-pointer text-sm">
                          Pay Now
                        </span>
                      </td>
                    )}
                  {item?.status === "Accept" &&
                    checkPaymentStatus(item) === "Paid" && (
                      <td className="px-5 py-3 leading-6 text-center whitespace-nowrap">
                        <span className="text-status-success cursor-not-allowed text-sm">
                          Paid
                        </span>
                      </td>
                    )}
