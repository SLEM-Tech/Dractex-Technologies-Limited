...
const PriceRangeSection = ({
  ...
  return (
    <section className="flex flex-col bg-white border-[1px] border-neutral-border">
      <h4 className="text-center py-3 slg:py-6 text-sm slg:text-base font-[400] leading-[1.3] text-secondary-200 bg-neutral-surface border-b-[1px] border-neutral-border">
        Price range
      </h4>
