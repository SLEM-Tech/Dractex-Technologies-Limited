...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-gray-600 space-y-6 text-xs sm:text-sm">
      <p>
        At Dractex Technologies Limited, we strive for 100% accuracy in every
      ...
      <section>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          ...
          <li>
            ...
            our error, Dractex Technologies Limited covers the return shipping.
      ...
      <section>
        ...
        <p>
          At Import, we act as your dedicated procurement agent. While we vet
