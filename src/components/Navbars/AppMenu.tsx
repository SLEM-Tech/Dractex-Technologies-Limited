  ...
  return (
    <>
      ...
      <div className="sm:hidden fixed bottom-0 z-50 w-full">
        {/* Background with dark style */}
        <div className="relative bg-dark border-t border-white/10 backdrop-blur-md">
          {/* Navigation Items */}
              ...
              return (
                <button
                  ...
                  {totalItems > 0 && menuItem.badge && menuItem.badge > 0 && (
                    <span className="absolute -top-1 right-1/4 bg-primary text-white text-[10px] rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 font-bold z-10">
