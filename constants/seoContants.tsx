...
export const SITE_NAME = "Dractex Brand Foundation";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://dractex.com"; // Update with actual URL
export const TWITTER_HANDLE = "@DractexBrand";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Dractex Brand Foundation provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
  ...
  home: {
    ...
    description:
      "Innovate and grow with Dractex Brand Foundation. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Dractex client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Dractex dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Dractex Brand Foundation and access premium tech resources.",
    keywords: [
      "Get started with Dractex",
      "Project onboarding",
      "Digital partnership",
    ],
  },
